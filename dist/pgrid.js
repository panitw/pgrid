		...
		value: function _editCell(cell) {
			...
			if (this._grid.model.canEdit(actualRow, actualCol)) {
				...
				if (customEditor && customEditor.canEdit) {
					var rowId = this._grid.model.getRowId(actualCell.dataset.rowIndex);
					var field = this._grid.model.getColumnField(actualCell.dataset.colIndex);
					var dataRow = this._grid.data.getRowData(rowId);
					var e = {
